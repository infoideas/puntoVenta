...
public class LocalCarniceria  implements java.io.Serializable {
    ...
    public LocalCarniceria(Localidad localidad, Provincia provincia, int idClienteEstancia, String nombreComercial, String direccion, char estado) {
